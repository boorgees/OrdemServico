...
namespace OrdemServicoAPI.Models
{
    ...
    public class OrdemServico
    {
        ...
        [ForeignKey("Servico"), Required(ErrorMessage = "O serviço é obrigatório"), DisplayName("Serviço")]
        ...
        [Required(ErrorMessage = "A data de início é obrigatória"), DataType(DataType.Date), DisplayName("Data de Início"), DisplayFormat(DataFormatString = "{0:dd/MM/yyyy}")]
